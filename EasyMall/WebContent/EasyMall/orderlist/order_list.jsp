			...
			<dd style="line-height: 26px;">
				...
				支付状态：
					...
					<c:if test="${ orderInfo.order.paystate == 1 }">
						...
						<a href="#">
							<img src="${app}/EasyMall/orderlist/img/orderList/sc.jpg" width="69" height="19"/>
						</a>
						&nbsp;
				 		<a href="#"> 
					 		<img src="${app}/EasyMall/orderlist/img/orderList/zx.jpg" width="69" height="19">
						</a>
						<br /> 
				所属用户：${ user.username }
				<br/> 
		...
		<c:forEach items="${ orderInfo.map }" var="entry">
			<tr>
				<td align="center" valign="middle" bgcolor="#FFFFFF">
					<img src="prodImgServlet?imgurl=${ entry.key.imgurl }" width="90" height="105">
				</td>
