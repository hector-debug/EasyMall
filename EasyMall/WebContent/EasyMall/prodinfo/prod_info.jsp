...
<html>
<head>
	<link href="${app }/EasyMall/prodinfo/css/prodInfo.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<div id="warp">
		<div id="left">
			<div id="left_top">
				<img src="prodImgServlet?imgurl=${prod.imgurl}"/>
			</div>
			<div id="left_bottom">
				<img id="lf_img" src="EasyMall/prodinfo/img/prodInfo/lf.jpg"/>
				<img id="mid_img" src="prodImgServlet?imgurl=${prod.imgurl}" width="60px" height="60px"/>
				<img id="rt_img" src="EasyMall/prodinfo/img/prodInfo/rt.jpg"/>
			</div>
		</div>
